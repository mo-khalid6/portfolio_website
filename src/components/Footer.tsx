      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xl font-display font-bold text-primary">MF.</span>
            <span className="text-text-secondary text-sm">
              Muhammad Fouad · Data Analyst
            </span>
          </div>
        ...
        {/* Bottom bar */}
        <div className="mt-8 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-text-secondary">
          <p>© {currentYear} Muhammad Fouad. All rights reserved.</p>
          <p className="flex items-center gap-1">
            Built with
            <span className="text-primary font-semibold mx-1">React + Vite + Tailwind</span>
            · Design by
            <span className="text-primary font-semibold mx-1">Google Stitch</span>
          </p>
        </div>
      </div>
    </footer>
